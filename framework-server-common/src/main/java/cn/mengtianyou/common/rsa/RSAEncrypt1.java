package cn.mengtianyou.common.rsa;
...
public class RSAEncrypt1 {
    ...
    public static void main(String[] args){
        RSAEncrypt1 rsaEncrypt= new RSAEncrypt1();
        //rsaEncrypt.genKeyPair();

        //加载公钥
        try {
            rsaEncrypt.loadPublicKey(RSAEncrypt1.DEFAULT_PUBLIC_KEY);
        ...
        //加载私钥
        try {
            rsaEncrypt.loadPrivateKey(RSAEncrypt1.DEFAULT_PRIVATE_KEY);
        ...
        try {
            ...
            System.out.println(RSAEncrypt1.byteArrayToString(cipher));
            System.out.println("明文长度:"+ plainText.length);
            System.out.println(RSAEncrypt1.byteArrayToString(plainText));
